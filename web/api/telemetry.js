...
module.exports = async (req, res) => {
  ...
  // simple auth: expect X-API-KEY header matching TELEMETRY_KEY (configure in Vercel)
  if (TELEMETRY_KEY) {
    const key = req.headers['x-api-key'] || req.headers['x-api-key'.toLowerCase()];
